...
<!--       for login start heare -->
       ...
       <div class="container">
         <marquee behavior="alternate" direction="right" scrollamount="20"> <h2 style="text-shadow: 0px 0px 0px ; color: rgb(16, 17, 17);"><b> User_Login </b></h2></marquee>
        ...
        <form action="vmanagemnetlogin" method="post">
             ...
             <div class="input">
              ...
              <div class="input">
               <label for="otp">OTP:<span id="otpmsg" style="margin-left:20px "></span> <span style="color:red;">${forotp}</span> </label>
...
<!--     for admin login start hear -->
 ...
 <div class="container2">
         <marquee behavior="alternate" direction="right" scrollamount="20"> <h2 style="text-shadow: 0px 0px 0px ; color: rgb(16, 17, 17);"><b> Admin_Login </b></h2></marquee>
