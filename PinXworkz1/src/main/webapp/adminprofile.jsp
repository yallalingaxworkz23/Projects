    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid" style="background-color:  #88ceec;">
          ...
          <div>
          <button class="w3-button w3-green w3-large" > <a href="viewInvoice" / style="text-decoration: none;color: white;"> View Invoice's </button>
         </div>
          <div>
           <button class="w3-button w3-green w3-large" > <a href="viewForProducts" / style="text-decoration: none;color: white;"> View Products </button>
           </div>
          <a class="navbar-brand" href="index.jsp" style="margin-left: 400px ; font-size: 35px; color:white;">
            <b>Home</b></a>
...
<!--       </div> -->
      ...
      <div class="footer">
        <div>
          ...
          <p style="margin-left: 650px; margin-top: -20px">Copyright  2024, All Right Reserved</p>
