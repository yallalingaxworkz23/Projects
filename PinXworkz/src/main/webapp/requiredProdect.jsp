...
<nav class="navbar navbar-expand-lg bg-body-tertiary"  >
        <div class="container-fluid" style="background-color: #88ceec;">
         <div>
             ...
             <img alt="person" style="height:40px;width: 40px; border-radius: 50%; margin-left:890px ;margin-top: 5px"
         ...
         <p style="margin-bottom: -0px;margin-left: 15px" ;><b> ${admimEmailid}</b></p>
          <a class="navbar-brand" href="backtoprofilebyrp"  style="margin-left: 50px ; font-size: 35px; color:white;"> <b>Home</b></a>
