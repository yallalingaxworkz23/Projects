 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous" >
    ...
    <style>
     ...
     background-color: #88ceec;
      ...
      .container {
    margin-left: 0px;
    /* to keep distance from margin top */
    margin-top:50px;
    /* gap in-between contant and border*/
    padding-left: 150px;
...
/*     border-bottom: 3px solid; */
   ...
   /* to make text hidden and show along with moment */
/*      overflow: hidden; */
    animation: type 3.5s  alternate-reverse   infinite  ;
    /* to come line vise not up and down*/
/*       white-space: nowrap; */
...
/*              background-color: rgb(89, 196, 241);  */
/*              color:aliceblue; */
/*               font-size: 10vh;  */
             /* top: inherit; */
/*              border-radius: 6vh; */
/*              text-decoration: rgb(219, 11, 11) ; */
/*               transform: scaleX(10);  */
...
<!--           <a class="navbar-brand" href="#"  style="margin-left: 890px ; font-size: 35px; color:white;"> <b>Home</b></a> -->
...
<!--           </button> -->
          <div class="collapse navbar-collapse" id="navbarNav" >
            <ul class="navbar-nav" >
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="login.jsp" style="color:white;  font-size: 25px; margin-left: 890px"><b>signin</b></a>
              </li>
              <li class="nav-item">
      ...
      <img alt="" src="https://img.freepik.com/free-vector/team-online-store-working-with-customer_1262-19368.jpg" width="550px" height="500px">
      <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzyrEoxpDK1su7Q4e4Z4AcDeleODLdpVSlfQ&usqp=CAU" style="border-bottom-left-radius: 70px;border-top-right-radius: 70px;margin-left: 100px">
      <img alt="" src="https://d38cf3wt06n6q6.cloudfront.net/tyasuitefront/webgpcs/images/vendor-management.png" width="400px" height="400px" style="margin-left: 120px">
...
<!-- &#128150 heart -->
<!-- &#128180 money-->
              <p style="font-size: 8vh;"> &#128400;</p>
              <p style="font-size: 8vh; margin-left: 110px; margin-top: -135px;"> &#128210;</p>
              <p style="font-size: 8vh; margin-left: 210px; margin-top: -145px;"> &#128421;</p>
              <p style="font-size: 9vh; margin-left: 310px; margin-top: -155px;"> &#128514;</p>
              <p style="font-size: 11vh; margin-left: 410px; margin-top: -178px;"> &#128540;</p>
              <p style="font-size: 13vh; margin-left: 510px; margin-top: -195px;"> &#128525;</p>
              <p style="font-size: 15vh; margin-left: 620px; margin-top: -215px;"> &#128330;</p>
    </div>
