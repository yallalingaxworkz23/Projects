...
<body>
   ...
   <div class="container">
  <marquee behavior="alternate" direction="right" scrollamount="20" > <h2 style="text-shadow: 0px 0px 0px ; color: rgb(16, 17, 17);"> <b> InVoice_List</b></h2></marquee>
              ...
              <table class="table"> 
                   ...
                   <c:forEach items="${viewInvoiceList}" var="viewinvoicelist">
          <tr>
            <td>${viewinvoicelist.orderId}</td>
            <td>${viewinvoicelist.price}</td>
            <td>${viewinvoicelist.delivarycharge}</td>
            <td>${viewinvoicelist.discription}</td>
            <td>${viewinvoicelist.status}</td>
            
            <td><a href="onOrder?orderId=${viewinvoicelist.orderId}" style="margin-bottom: 8px;margin-right: 0px"><button id="button" 
            onclick="order()" style="margin-top: -5px" ${viewinvoicelist.status eq "Orderd"
             ? 'disabled="disabled" class="bg-light text-primary"' : ''} >order</button></a></td>
          </tr>
        </c:forEach>
