    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary"  >
        <div class="container-fluid" style="background-color:  #88ceec;">
            ...
            <div>
             ...
             <img alt="person" style="height:40px;width: 40px; border-radius: 50%; margin-left:55vh; margin-top: 5px"
         ...
         <b>${vdata.emailid }</b>
          <a class="navbar-brand" href="index.jsp"  style="margin-left: 500px ; font-size: 35px; color:white;"> <b>Home</b></a>
       ...
       <div class="container">
         <marquee behavior="alternate" direction="right" scrollamount="20" style="background-color: #91c7e0;"> <h2 style="text-shadow: 8px -5px 4px ; color: rgb(16, 17, 17);">Updateing_Profile</h2></marquee>
