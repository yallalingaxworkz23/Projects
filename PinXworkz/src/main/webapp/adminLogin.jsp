...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary"  >
        <div class="container-fluid" style="background-color:  #88ceec;">
          ...
          <a class="navbar-brand" href="index.jsp"  style="margin-left: 860px ; font-size: 35px; color:white;"> <b>Home</b></a>
...
<!--             </ul> -->
       ...
       <div class="container2">
         <marquee behavior="alternate" direction="right" scrollamount="20" style="background-color:wite;"> <h2 style="text-shadow: 0px 0px 0px ; color: rgb(16, 17, 17);"><b> Admin_Page </b></h2></marquee>
       ...
       <form action="adminlogin" method="post">
             ...
             <div class="input">
               ...
               <input type="email" id="emailid" name="emailid" placeholder="Enter your  email Id " onchange="emailvalidation()" required="required">
             </div>
