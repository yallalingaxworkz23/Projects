...
<body>
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary"  >
        <div class="container-fluid" style="background-color:  #88ceec; style="display: flex"">
          ...
          <a class="navbar-brand" href="index.jsp"  style="margin-left: 740px ; font-size: 35px; color:white;"> <b>Home</b></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <img alt="person" style="height:40px;width: 40px; border-radius: 50%; margin-left:0px ;margin-top: 5px"
